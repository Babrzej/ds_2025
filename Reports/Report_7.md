...
![png](Report_7_files/Report_7_15_0.png)
...
plt.title('Convenience Stores vs. Price per m^2')
...
![png](Report_7_files/Report_7_17_0.png)
...
plt.title('House Age vs Price per m^2')
...
![png](Report_7_files/Report_7_19_0.png)
...
plt.title('Distance to MRT Station vs. Price per m^2')
...
![png](Report_7_files/Report_7_21_0.png)
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x156200f70>




    
![png](Report_7_files/Report_7_23_1.png)
...
```
    ...
    /var/folders/ds/w2dv_s714hv1dnqxhrmw5w_c0000gn/T/ipykernel_76314/1453712097.py:1: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
      df_estate.groupby('house_age_cat_str')['price_twd_msq'].describe()
...
```
    ...
    Time:                        22:38:41   Log-Likelihood:                -1542.5
...
![png](Report_7_files/Report_7_31_0.png)
...
![png](Report_7_files/Report_7_34_0.png)
...
<tr>
  <th>Time:</th>                 <td>22:38:42</td>     <th>  Log-Likelihood:    </th> <td> -1530.2</td>
</tr>
<tr>
...
plt.ylabel("Price per m^2")
plt.title("Distance to MRT vs. Price per m^2")
plt.show()
```


    
![png](Report_7_files/Report_7_43_0.png)
...
plt.scatter(df_estate['log_distance_to_mrt'], df_estate['price_twd_msq'])
plt.xlabel('Log(Distance to MRT)')
plt.ylabel('Price per m^2')
plt.title('Log Distance to MRT vs. Price')
plt.show()
```


    
![png](Report_7_files/Report_7_44_0.png)
    



```python
print('Correlation before log transformation:', df_estate['dist_to_mrt_m'].corr(df_estate['price_twd_msq']))
print('Correlation after log transformation:', df_estate['log_distance_to_mrt'].corr(df_estate['price_twd_msq']))

```

    Correlation before log transformation: -0.6736128553689182
    Correlation after log transformation: -0.7343386405914876



```python
model3 = smf.ols('price_twd_msq ~ log_distance_to_mrt + house_age_0_15 + house_age_30_45', data=df_estate)
result3 = model3.fit()
result3.summary()
```
...
<tr>
  <th>Time:</th>                 <td>22:38:42</td>     <th>  Log-Likelihood:    </th> <td> -1497.6</td>
</tr>
<tr>
...
<tr>
  <th>log_distance_to_mrt</th> <td>   -8.7280</td> <td>    0.414</td> <td>  -21.083</td> <td> 0.000</td> <td>   -9.542</td> <td>   -7.914</td>
</tr>
<tr>
...
Counclusions:
- Model explains about 56% of price.
- Price goes down when log distance to MRT goes up (strong effect).
- Intercept means base price about 92.4.
- Model is good and log(distance) is useful.
...
```
    ...
    Time:                        22:38:42   Log-Likelihood:                -1525.6
...
![png](Report_7_files/Report_7_65_0.png)
    



    
![png](Report_7_files/Report_7_65_1.png)
    


These plots show that as the distance to the MRT station increases, the price per square meter generally decreases. The fitted line shows this negative relationship clearly, though there is a lot of spread in the actual data, especially for properties close to the MRT. The residual plot suggests some pattern in the errors, meaning the model doesn’t fully explain the variation in prices. Overall, the relationship is negative, but the model could be improved to better fit the data near the MRT.
